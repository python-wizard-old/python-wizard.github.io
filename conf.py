...
BLOG_AUTHOR = "Python Wizard"  # (translatable)
BLOG_TITLE = "Max's tech site"  # (translatable)
...
BLOG_EMAIL = "max.python.wizard@gmail.com"
BLOG_DESCRIPTION = "Tech wizardry of Max"  # (translatable)
